 ...
 * @author Ruri
 */
@WebServlet(name = "verModificar", urlPatterns = {"/vermodificar.do"})
public class verModificar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
           ...
           AlumnoDAO miAlumno = new AlumnoDAO();
        ArrayList<AlumnoDTO> listaAlumnos = new ArrayList();
        listaAlumnos = (ArrayList) miAlumno.readAll();
